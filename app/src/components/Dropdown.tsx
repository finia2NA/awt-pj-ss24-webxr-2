                    ...
                    >
                        <div className="py-1" role="none">
                            {items.map((item: string, index: number) => (
                                <a
                                    key={index}
                                    className="text-primary dark:text-dark-primary block px-4 py-2 text-sm hover:bg-dark-mainBG dark:hover:bg-dark-primary hover:text-dark-primary dark:hover:text-primary cursor-pointer rounded"
                                    role="menuitem"
