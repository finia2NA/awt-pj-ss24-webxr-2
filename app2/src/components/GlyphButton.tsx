...
const GlyphButton = (props: GlyphButtonProps) => {
  const { type, active, disabled, onClick, customStyle, ignoreAnimation } = props;
  const icon = buttonIcons.get(type);

  return (
    <Container padding={0} paddingBottom={0} width={100} height={20} borderRadius={20} backgroundColor="white" hover={{ backgroundOpacity: 1 }}>
